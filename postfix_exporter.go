...
var (
	...
	smtpdFCrDNSErrorsLine               = regexp.MustCompile(`^hostname \S+ does not resolve to address `)
	...
	smtpdSASLAuthenticationFailuresLine = regexp.MustCompile(`^SASL authentication failed;`)
